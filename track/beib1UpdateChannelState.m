...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function tR = beib1UpdateChannelState(signalSettings,tR,ch)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Update track state for beidou signal tracking
%
% Inputs:
...
elseif (trackChannelData.pllLockIndicator(loopCnt)<trackChannelData.pllWideBandLockIndicatorThreshold)    
...
trackChannelData = beib1setTrackingTable(trackChannelData, trackChannelData.trackState);
