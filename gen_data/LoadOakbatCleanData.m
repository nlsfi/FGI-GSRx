...
%% load mat file
load('E:\Old_data\data\oakbat\mat\oakbat_gps\trackData_GPSL1_oakbat_cleanStatic_dev.mat');

%% define the struct of traindata
c=299792458;
f_L1=1575.42e6;
nrOfEpochs = size(obsData,2);
Datalist = 16; % second of week;prn;sqm-mv;sqm-ma;cn0-mv;cn0-ma;pse;codephase;doppler;pd;spoofed mask;
...
%         lastpse=pse;
        ...
        TrainData(row,12)=Mn;
        TrainData(row,13)=1;
%         if obsData{1,epo}.gpsl1.channel(sat).channelStartIndex>110000
%             TrainData(row,13)=0;
%         end
        TrainData(row,14)=dt;
        TrainData(row,15)=pf;
...
TrainData_oakbat_clean=TrainData;
save('train_data_oakbat_clean.mat','TrainData_oakbat_clean');