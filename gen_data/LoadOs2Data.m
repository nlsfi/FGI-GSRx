...
%% load mat file
load('E:\Old_data\data\oakbat\mat\oakbat_gps\trackData_GPSL1_oakbat_os2_dev.mat');
...
%         lastpse=pse;
        ...
        %% 解算层特征
        rangeRes=obsData{1,epo}.gpsl1.channel(sat).rangeResid;%伪距残差
        dopplerResid=obsData{1,epo}.gpsl1.channel(sat).dopplerResid;%多普勒残差
...
TrainData_os2=TrainData;
save('train_data_os2.mat','TrainData_os2');