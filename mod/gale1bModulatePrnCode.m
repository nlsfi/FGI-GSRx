...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [modCodeReplica,signalSettings] = gale1bModulatePrnCode(codeReplica,signalSettings)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if (strcmp(signalSettings.modType,'CBOC')==1)
    ...
    modCodeReplica = sqrt(10/11)*modCodeReplicaBOC11_up  + sqrt(1/11)*modCodeReplicaBOC61; %CBOC(+) implementatin for data channel
else
